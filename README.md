...
(Este contenido es guardado como base64 porque sera condificado por json, debe aplicarse un base64 decode para obtener el contenido exacto)
| Variable | Posicion | Largo | Contenido |
| :--- | :--- | :--- | :--- |
